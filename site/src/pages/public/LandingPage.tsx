      ...
      <header className="fixed inset-x-0 top-0 z-50 border-b border-white/[0.06] bg-gray-950/80 backdrop-blur-xl">
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-6">
          ...
          <div className="flex items-center gap-3">
            <a
              href="https://github.com/IHaveInhaler/library-system"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 rounded-full bg-white/[0.06] px-3.5 py-2 text-sm font-medium text-gray-400 ring-1 ring-white/[0.08] transition-all hover:bg-white/[0.1] hover:text-white hover:ring-white/[0.15]"
            >
