...
export default function AdminHomePage() {
  ...
  const stats = [
    { label: 'Active Loans', value: activeLoans?.meta.total ?? '…', color: 'blue', href: '/admin/loans' },
    { label: 'Overdue', value: overdueLoans?.meta.total ?? '…', color: 'red', href: '/admin/loans?status=OVERDUE' },
    { label: 'Pending Reservations', value: pendingRes?.meta.total ?? '…', color: 'yellow', href: '/admin/reservations' },
    { label: 'Books in Catalogue', value: books?.meta.total ?? '…', color: 'green', href: '/admin/books' },
  ]

  const links = [
    { icon: BookOpen, label: 'Manage Books', href: '/admin/books' },
    { icon: Library, label: 'Manage Libraries', href: '/admin/libraries' },
    { icon: ClipboardList, label: 'Loans', href: '/admin/loans' },
    { icon: Bookmark, label: 'Reservations', href: '/admin/reservations' },
