...
router.post('/', authorizePermission('CREATE_USER'), validate(createUserSchema), controller.create)
...
router.delete('/:id', authorizePermission('DELETE_USER'), controller.remove)
